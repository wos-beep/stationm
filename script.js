const APP_VERSION = "3.5.4", STORAGE_KEY = 'wos_st_manage_data', DUR = 72 * 3600000;
...
function shareURL() {
    const compact = { s: userState.selectedIds, t: userState.timers, m: userState.modes };
    const d = btoa(JSON.stringify(compact));
